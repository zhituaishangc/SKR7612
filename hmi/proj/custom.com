...
//M(Mask18/$85020/"panel_18_4_chs.png"/)
	...
	DEF SHOUJIAN=(I/*0=$85082,1=$85083//$85089,,,/WR2/"panel_blank_chs.png"/"/NC/_N_NC_GD2_ACX/TOOL_SET[58]"/0,0,0/270,10,70/);是否是首件工件	
	...
	DEF para_switch=(I/*0=$85058,1=$85059//$85063,$85063,,/WR2/"panel_18_27_chs.png"/"/NC/_N_NC_GD2_ACX/PARA_LOCK_SWITCH[30]"/0,0,0/185,350,20/);参数锁定开关
...
//M(Mask3/$85022/"panel_3_4_chs.png"/)
	...
	DEF SHI_JIAN=(R/0,80//$85332,$85332,,$85047/WR2/"panel_17_1_chs.png"/"/NC/_N_NC_GD2_ACX/WHEEL[19]"/90,250,110/200,250,110/);滚压轮停留时间
	DEF VAR32=(R/0,50//$85330,$85330,,$85043/WR2/"panel_17_3_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[2]"/90,270,110/200,270,110/);齿高
	DEF DANG_QIAN_JIE_CHU=(R/-500,500//$85399,$85399,,$85043/WR2/"panel_17_4_chs.png"/"/NC/_N_NC_GD2_ACX/WHEEL[11]"/90,290,110/200,290,110/);当前接触位置
	DEF VAR34=(R/0,500//$85396,$85396,,$85043/WR2/"panel_17_5_chs.png"/"/NC/_N_NC_GD2_ACX/WHEEL[1]"/90,310,110/200,310,110/);修整轮直径
	DEF VAR33=(R/-500,500//$85398,$85398,,$85043/WR1//"/NC/_N_NC_GD2_ACX/WHEEL[15]"/90,330,110/200,330,110/);初始接触位置
...
//M(Mask21/$85026/"panel_21_2_chs.png"/)
	...
	DEF VAR3=(R/0,500//$85505,$85505,,$85043/WR2/"panel_21_6_chs.png"/"/NC/_N_NC_GD2_ACX/TOOL_SET[24]"/330,90,160/440,90,110/7,4);内螺纹测头球中心/接近开关探测面与磨杆距离(X向)
...
//M(MASK23/$85066//)
	...
	DEF WAIYUAN=(I/*0=$85081,1=$85080//$85032,$85032,,/WR1,al0,fs2,li0,cb0//"/NC/_N_NC_GD2_ACX/PROCESS[44]"/330,85,100/440,85,60);外圆磨削开关
	DEF YOUDUANMIAN=(I/*0=$85081,1=$85080//$85034,$85034,,/WR1,al0,fs2,li0,cb0//"/NC/_N_NC_GD2_ACX/PROCESS[46]"/330,137,100/440,137,60);右端面磨削开关
	DEF ZUODUANMIAN=(I/*0=$85081,1=$85080//$85033,$85033,,/WR1,al0,fs2,li0,cb0//"/NC/_N_NC_GD2_ACX/PROCESS[45]"/330,190,100/440,190,60);左端面磨削开关
	DEF WAIYUAN_TAIJIE=(I/*0=$85081,1=$85080//$85028,$85028,,/WR1,al0,fs2,li0,cb0//"/NC/_N_NC_GD2_ACX/PROCESS[95]"/320,240,110/440,240,60);外圆台阶磨削开关
	DEF NEILUOWEN=(I/*0=$85081,1=$85080//$85031,$85031,,/WR1,al0,fs2,li0,cb0//"/NC/_N_NC_GD2_ACX/PROCESS[42]"/330,295,100/440,295,60);内螺纹磨削开关
...
//M(MASK24/$85019/"panel_24_0_chs.png"/)
	...
	DEF VAR14=(R///$85098,$85098,$85043,/WR1///30,25,190/120,25,60/);正常磨削设定磨削总量显示
	...
	DEF TYPE=(I////WR4//"/NC/_N_NC_GD2_ACX/GRIND[1]"/0,0,0/0,0,0/);磨削类型
	DEF ZHUIDUTIAOZHENG=(R///$85084,$85084,,/WR2//"/NC/_N_NC_GD2_ACX/WAIYUAN[5]"/350,330,130/450,330,60/);外圆锥度调整
...
//END
;;;;;;;;;;;;;;;;;MASK_TAIJIE;外圆台阶面磨削;;;;;;;;;;;;;;;;;;
//M(MASK_TAIJIE/$85087/"taijie.png"/)
	DEF TAIJIECHANGDU=(R/0,200//$85085,$85085,$85043,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[56]"/40,20,220/160,20,60/);外圆上的台阶长度
    DEF TAIJIESHENDU=(R///$85086,$85086,,$85043/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[57]"/320,20,120/440,20,110/);台阶深度
	DEF GONGJIAN_JISHU=(I///$85227,$85227,$85228,/WR2//"/NC/_N_NC_GD2_ACX/INI[94]"/40,40,220/160,40,60/);已加工工件计数
	DEF JIJIAN_XIUZHENG=(I///$85095,$85095,,$85228,/WR2//"/NC/_N_NC_GD2_ACX/INI[95]"/320,40,140/440,40,110/);计件修整设定的件数
		
	DEF JING_CISHU=(R///$85094,,,/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[267]"/320,105,120/220,105,60/);精磨次数

	DEF CU_JINGEI=(R/0,1//$85092,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[100]"/40,130,220/130,130,60/);粗磨进刀量
    DEF JING_JINGEI=(R/0,1//$85093,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[101]"/320,130,120/220,130,60/);精磨进刀量
	
	DEF CU_TOUJIA=(R/0,200//$85088,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[97]"/40,155,220/130,155,60/);粗磨头架转速
    DEF JING_TOUJIA=(R///$85089,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[98]"/320,155,120/220,155,60/);精磨头架转速
	
	;DEF CU_Z_SUDU=(R///$85090,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[103]"/40,178,220/130,178,60/);粗磨Z轴速度
    DEF JING_Z_SUDU=(R///$85091,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[104]"/320,179,120/220,179,60/);精磨Z速度
	
	VS1=($85032,ac7,se1);调用外磨工艺表格
	VS2=($85029,ac7,se1);端面磨削
	VS3=($85087,ac7,se3);台阶磨削
	HS8=($85005,ac7,se1);返回
