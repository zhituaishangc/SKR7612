...
//M(Mask3/$85022/"panel_3_4_chs.png"/)
	...
	DEF para_switch3=(I/*0=$85058,1=$85059//$85063,$85063,,/WR2/"panel_blank_chs.png"/"/NC/_N_NC_GD2_ACX/PARA_LOCK_SWITCH[9]"/0,0,0/310,270,18/);锁定当前接触的开关	
	...
	DEF XZLXSD=(R/0,60//$85323,$85323,,$85046/WR2/"panel_17_6_chs.png"/"/NC/_N_NC_GD2_ACX/WHEEL[2]"/90,330,110/200,330,110/);修整轮线速度
	DEF XZLZS=(I///$85325,$85325,,$85044/WR1//"/NC/_N_NC_GD2_ACX/WHEEL[20]"/90,350,110/200,350,110/);修整轮转速
	...
	CHANGE(VAR34)
		CALL("UP5")
		XZLZS.VAL=XZLXSD.VAL*60000/(PI*VAR34.VAL)
	END_CHANGE
	CHANGE(para_switch1)
...
//M(MASK26/$85035//)
	...
	DEF ZHUIDUTIAOZHENG=(R///$85084,$85084,,/WR2//"/NC/_N_NC_GD2_ACX/WAIYUAN[5]"/330,240,110/440,240,60/);外圆砂轮锥度调整
